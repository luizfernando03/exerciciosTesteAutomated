...
public class TestRemoverNumeroDuplicado {
    ...
    public void testRemoveNumeroDuplicados() {
        List<Integer> numeros = Arrays.asList(3, 4, 5, 3, 2, 1, 2);                  // Cria uma lista de numeros com duplicados
        List<Integer> resultadoEsperado = Arrays.asList(3, 4, 5, 2, 1);              // Cria a lista com o resultado esperado
